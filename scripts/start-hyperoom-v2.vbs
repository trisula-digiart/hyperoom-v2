' ============================================================
' HYPEROOM v2 — Home Server Launcher (v2 — fix DB ready wait)
...
' --- 2) Tunggu sebentar (postgres booting) ---
WScript.Sleep 5000

' --- 3) Backend :3100 (port kosong? start — backend retry DB sendiri) ---
...
' --- 5) tunggu server siap, baru buka browser ---
sh.Run "cmd /c ""timeout /t 8 /nobreak >nul & start http://localhost:3101""", 0, False